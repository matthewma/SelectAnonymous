...
using SelectAnonymous.RelationClasses;
...
namespace SelectAnonymous.FactoryClasses
{
	...
	{
		private readonly SelectAnonymous.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, SelectAnonymous.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		{
			return GeneralEntityFactory.Create((SelectAnonymous.EntityType)entityTypeValue);
		}
	...
	public partial class StudentEntityFactory : EntityFactoryBase2<StudentEntity> {
		/// <summary>CTor</summary>
		public StudentEntityFactory() : base("StudentEntity", SelectAnonymous.EntityType.StudentEntity, false) { }
		
		/// <summary>Creates a new StudentEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new StudentEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewStudentUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
	...
	/// <summary>Factory to create new, empty TeacherEntity objects.</summary>
	[Serializable]
	public partial class TeacherEntityFactory : EntityFactoryBase2<TeacherEntity> {
		/// <summary>CTor</summary>
		public TeacherEntityFactory() : base("TeacherEntity", SelectAnonymous.EntityType.TeacherEntity, false) { }
		
		/// <summary>Creates a new TeacherEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new TeacherEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewTeacherUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		#region Included Code
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(SelectAnonymous.EntityType entityTypeToCreate)
		{
			IEntityFactory2 factoryToUse = null;
			switch(entityTypeToCreate)
			{
				case SelectAnonymous.EntityType.StudentEntity:
					factoryToUse = new StudentEntityFactory();
					break;
				case SelectAnonymous.EntityType.TeacherEntity:
					factoryToUse = new TeacherEntityFactory();
					break;
			}
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(SelectAnonymous.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((SelectAnonymous.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the SelectAnonymous.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(SelectAnonymous.EntityType typeOfEntity)
		{
	...
	{
		/// <summary>Gets the factory of the Entity type with the SelectAnonymous.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (SelectAnonymous.EntityType)Enum.Parse(typeof(SelectAnonymous.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((SelectAnonymous.EntityType)Enum.Parse(typeof(SelectAnonymous.EntityType), leftOperandEntityName, false), joinType, (SelectAnonymous.EntityType)Enum.Parse(typeof(SelectAnonymous.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation(leftOperand, joinType, (SelectAnonymous.EntityType)Enum.Parse(typeof(SelectAnonymous.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the SelectAnonymous.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((SelectAnonymous.EntityType)entityTypeValue);
		}
